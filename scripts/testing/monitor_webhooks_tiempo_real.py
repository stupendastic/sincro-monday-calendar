#!/usr/bin/env python3
"""
Script para monitorear los webhooks en tiempo real
"""
import subprocess
import time
import sys

def monitor_webhooks_tiempo_real():
    """Monitorea los webhooks en tiempo real"""
    
    print("📊 MONITOR DE WEBHOOKS EN TIEMPO REAL")
    print("=" * 60)
...
def main():
    """Función principal"""
    print("🚀 MONITOR DE WEBHOOKS MONDAY ↔ GOOGLE")
    print("=" * 80)
