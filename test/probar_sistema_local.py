#!/usr/bin/env python3
"""
Script para probar el sistema de UUIDs únicos localmente
"""
import requests
import json
import time
...
def probar_sistema_local():
    """Prueba el sistema de UUIDs únicos localmente"""
    
    print("🧪 PROBADOR DEL SISTEMA DE UUIDs ÚNICOS (LOCAL)")
    print("=" * 60)
    ...
    for i in range(3):
        ...
        webhook_data = {
            ...
            "columnId": "fecha56",
            "value": {
                "text": f"2025-08-{20+i} 16:00:00"
            },
            "previousValue": {
                "text": f"2025-08-{19+i} 16:00:00"
            },
            "triggerTime": "2025-08-22T23:50:00.000000",
...
def mostrar_instrucciones():
    ...
    print("   - Cooldown reducido a 3 segundos")
    print("=" * 60)

def main():
    """Función principal"""
    print("🚀 SISTEMA DE UUIDs ÚNICOS - MONDAY ↔ GOOGLE (LOCAL)")
    print("=" * 80)
